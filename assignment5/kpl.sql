...
--
-- Host: localhost:3306
-- Generation Time: Mar 22, 2020 at 08:36 AM
...
--
-- Dumping data for table `kpl`
--

INSERT INTO `kpl` (`teamID`, `team`, `area`, `lineup_members`, `schedules`, `url`, `desc`) VALUES
(1, 'eStarPro', 'EAST', 'Cat, Huahai, WuMing, Alan, NuoYan', 'RW,eStarPro,eStarPro,eStarPro,eStarPro', 'https://dl.airtable.com/.attachments/bf1d0ce0f98ed9fba61205fbaddf502e/5df79361/ESTAR.png', 'eStar pro是东部地区战队，主场武汉，曾获2019年春季赛总冠军。首发队员：eStar.Cat 中单；eStar.Huahai 打野 ；eStar.Wuming 辅助；eStar.Nuoyan 边路 ； eStar.Alan 边路。'),
...
(15, 'JDG', 'WEST', 'DAD,DAD,DSA', 'WE、AG', NULL, NULL);
...
--
ALTER TABLE `kpl`
  MODIFY `teamID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
