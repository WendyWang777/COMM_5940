          ...
          function openForm(recEntry,whichForm) {
              ...
              if (whichForm == 'add') {
                 $("#myAddForm").modal();
                  ...
                  document.getElementById("add_lineup_members").value = 0;
                  document.getElementById("add_schedules").value = 0;
                  // document.getElementById("add_record_id").value = recEntry[0];
              } else if (whichForm == 'update') {
                 $("#myUpdateForm").modal();
                  document.getElementById("upd_team_id").value = recEntry[0];
                  document.getElementById("upd_team").value = recEntry[1];
                  document.getElementById("upd_area").value = recEntry[2];
                  document.getElementById("upd_lineup_members").value = recEntry[3];
                  document.getElementById("upd_schedules").value = recEntry[4];
                  document.getElementById("upd_record_id").value = recEntry[0];
              } else {
                  $("#myDeleteForm").modal();
                  document.getElementById("del_team_id").value = recEntry[0];
                  document.getElementById("del_team").value = recEntry[1];
                  document.getElementById("del_area").value = recEntry[2];
                  document.getElementById("del_lineup_members").value = recEntry[3];
                  document.getElementById("del_schedules").value = recEntry[4];
